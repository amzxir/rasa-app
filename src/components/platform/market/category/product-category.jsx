...
export default function ProductCategory({ sendProduct }) {
    ...
    const handelProductCategory = async () => {
        ...
        try {
            const response = await axios.post("https://rasadent.com/api/ProductCategory", bodyParameters, config);
    ...
    useEffect(() => {
        const handelSubCategory = async () => {
            ...
            try {
                const response = await axios.post("https://rasadent.com/api/ListSubCategory", bodyParameters, config);
