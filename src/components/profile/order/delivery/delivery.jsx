...
export default function Delivery({ productOrder , sendInvoice }) {
                                ...
                                <Card sx={{ boxShadow:'0px 2px 4px 0px #00000040' , borderRadius:'15px' , p:2 }}>
                                    <div className={theme.palette.mode === "light" ? LightStyles.delive : DarkStyles.delive}>
                                        <div className={theme.palette.mode === "light" ? LightStyles.content : DarkStyles.content}>
                                            <h1><img src="/image/invo.svg" alt="" /> {i.name}</h1>
                                        ...
                                        <div className={theme.palette.mode === "light" ? LightStyles.btn_or : DarkStyles.btn_or}>
                                            <NavLink onClick={() => sendInvoice(i)} to={`/profile/order/details/${i.name}`} state={fa["details order"]} className={theme.palette.mode === "light" ? LightStyles.btn_order : DarkStyles.btn_order}><ArrowBtnIcon/></NavLink>
                                        </div>
                                    </div>
                                </Card>
                            </Grid>
