...
export default function Cancelled({ productOrder, sendInvoice }) {
                                    ...
                                    <Card sx={{ boxShadow: '0px 2px 4px 0px #00000040', borderRadius: '15px', p: 2 }}>
                                        <div className={theme.palette.mode === "light" ? LightStyles.delive : DarkStyles.delive}>
                                            <div className={theme.palette.mode === "light" ? LightStyles.content : DarkStyles.content}>
                                                <h1 style={{ color: '#EC5A1C' }}><img src="/image/order-cancel.svg" alt="" />{i.name}</h1>
                                            ...
                                            <div className={theme.palette.mode === "light" ? LightStyles.btn_or : DarkStyles.btn_or}>
                                                <NavLink onClick={() => sendInvoice(i)} to={`/profile/order/details/${i.name}`} state={fa["details order"]} className={theme.palette.mode === "light" ? LightStyles.btn_order_orange : DarkStyles.btn_order_orange}><ArrowBtnIcon /></NavLink>
                                            </div>
                                        </div>
                                    </Card>
                                </Grid>
